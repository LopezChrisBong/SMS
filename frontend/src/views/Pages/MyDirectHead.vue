    ...
    <v-card class="mt-2">
      <v-row>
        <v-col cols="12">
          ...
          <MyDirectHeadDataTable v-on:refresh="getHeadCount" />
        </v-col>
      </v-row>
    </v-card>

    <MyDirectHeadDialog :data="typeData" :action="action" />
  </div>
</template>
...
export default {
  components: {
    MyDirectHeadDataTable: () =>
      import("../../components/Utils/MyDirectHeadDataTable.vue"),
    MyDirectHeadDialog: () =>
