    ...
    <v-dialog v-model="confirmDialog" persistent max-width="450">
      <v-card color="white">
        ...
        <v-card-actions>
          ...
          <v-btn color="#147452" class="white--text" @click="confirmHiring()">
            Confirm
          </v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    <ShortListViewJobApplicant :data="designationData" :action="action" />
...
export default {
  ...
  components: {
    ShortListViewJobApplicant: () =>
      import("../Forms/ShortListViewJobApplicant.vue"),
  },
  data() {
    return {
      confirmDialog: false,
