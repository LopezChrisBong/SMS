<template>
  <div>
    ...
    <InstitutesDialog :data="updateData" :action="action" />
...
export default {
  components: {
    InstitutesDialog: () =>
      import("../../components/Dialogs/Forms/InstitutesDialog.vue"),
  },
  props: ["reloadTable"],
  data: () => ({
    search: "",
    headers: [
      ...
      { text: "Abbreviation", value: "abbr", align: "start" },
  ...
  mounted() {
    this.eventHub.$on("closeInstitutesDialog", () => {
      this.initialize();
    });
  },
  beforeDestroy() {
